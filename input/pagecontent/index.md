...
Suggested Sequence:
1. Introduction to HL7 FHIR
2. FHIR Molecular Definition resource
3. MolecularDefinition profiles and their corresponding genetic concepts
4. Supporting terminologies, i.e., code systems and value sets
